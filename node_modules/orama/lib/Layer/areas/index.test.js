...
(0, _mocha.it)('Chart/areas 1', function () {
  var renderData = (0, _.areas)({
    data: [{ x: 1, y: 1 }],
...
(0, _mocha.it)('Chart/areas 2', function () {
  var renderData = (0, _.areas)({
    data: [{ x: 1, y: 1, y0: 1 }],
    xScale: function xScale(d) {
      return d;
...
(0, _mocha.it)('Chart/areas grouped data', function () {
  var renderData = (0, _.areas)({
    data: [[{ x: 1, y: 1 }]],
    xScale: function xScale(d) {
      return d;
...
(0, _mocha.it)('Chart/areas.getPointData 1', function () {
  var pointData = (0, _.getPointData)({}, {});
  _assert2.default.deepEqual(pointData, undefined);
});
(0, _mocha.it)('Chart/areas.getPointData 2', function () {
  var props = {
    x: 'x', y: 'y',
    xScale: function xScale(d) {
      return d;
  ...
  var datum = { x: 10, y: 10 };
  var pointData = (0, _.getPointData)(props, datum, 'y');

  _assert2.default.deepEqual(pointData.type, 'area');
});

(0, _mocha.describe)('Chart/areas.hoverSolver', function () {
  var props = {
    x: 'x', y: 'y',
    xScale: scale,
    yScale: scale
